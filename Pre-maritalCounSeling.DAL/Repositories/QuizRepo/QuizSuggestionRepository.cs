...
namespace Pre_maritalCounSeling.DAL.Repositories.QuizRepo
{
    public class QuizSuggestionRepository : GenericRepository<QuizSuggestion>
    {
        ...
        public QuizSuggestionRepository(NET1718_RPR231_PRJ_G2_PremaritalCounselingContext context, ILogger logger, IHttpContextAccessor httpContextAccessor) : base(context)
        {
            this.logger = logger;
